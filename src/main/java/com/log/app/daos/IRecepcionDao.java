...
public interface IRecepcionDao extends JpaRepository<Recepcion, Long> {
    ...
    // "tipo_productos.nombre, tipo_productos.id_tipo_prod as idTipoProd"
            ...
            nativeQuery = true)
    List<ReporteProductosInterface> sumProductosSolicitadosByMonthBetweenFechas(Date fecharecepciontart,
    ...
    // "tipo_productos.nombre, tipo_productos.id_tipo_prod as idTipoProd"
            ...
            // "order by tipo_productos.id_tipo_prod ",
            nativeQuery = true)
    List<ReporteProductosInterface> sumProductosSolicitadosByMonthBetweenFechasByProducto(Date fecharecepciontart,
